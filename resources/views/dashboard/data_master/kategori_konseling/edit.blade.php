            ...
            <div class="card">
                <div class="card-header  pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Edit Kategori Konseling</h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST"
                            action="{{ route('admin.kategoriKonseling.update', $kategoriKonseling->id) }}">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama"
                                                ...
                                                value="{{ old('nama_kategori', $kategoriKonseling->nama_kategori) }}">
                                            @error('nama_kategori')
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="contoh_kategori"
                                                class="form-control @error('contoh_kategori') is-invalid @enderror"
                                                name="contoh_kategori" placeholder="Contoh : Kesehatan Mental"
                                                value="{{ old('contoh_kategori', $kategoriKonseling->contoh_kategori) }}">
...
@push('scripts')
    <script>
        const contohInput = document.getElementById('contoh_kategori');
