            ...
            <div class="card">
                <div class="card-header  pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.tahunAkademik') }}" class="btn btn-outline-warning" id="kembali"
                            id="cancel">Batal</a>
                        <script>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST"
                            action="{{ route('admin.tahunAkademik.update', $tahunAkademik->id) }}">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Contoh: 2023/2024" name="periode"
                                                value="{{ old('periode', $tahunAkademik->periode) }}">
                                            @error('periode')
