            ...
            <div class="card">
                <div class="card-header  pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.pekerjaan') }}" class="btn btn-outline-warning" id="kembali">Kembali</a>
                        <script>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST" action="{{ route('admin.pekerjaan.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
