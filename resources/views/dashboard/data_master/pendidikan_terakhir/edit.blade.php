            ...
            <div class="card">
                <div class="card-header  pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Edit Pendidikan Terakhir</h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST"
                            action="{{ route('admin.pendidikanTerakhir.update', $pendidikanTerakhir->id) }}">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama" value="{{ $pendidikanTerakhir->nama }}"
                                                    class="form-control @error('nama') is-invalid @enderror" name="nama"
                                                    placeholder="Nama Pendidikan Terakhir">
                                                @error('nama')
