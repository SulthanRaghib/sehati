            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        @if ($pendidikanTerakhir->count() == 0)
                            <div class="alert alert-info">
                                Data Pendidikan Terakhir belum ada. Silahkan tambahkan data pendidikan terakhir baru.
                            </div>
                        @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.pendidikanTerakhir.edit', $a->id) }}"
                                                    ...
                                                    data-bs-placement="top" title="Edit Pendidikan Terakhir"><i
                                                ...
                                                <form action="{{ route('admin.pendidikanTerakhir.destroy', $a->id) }}"
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-danger btn-delete"
                                                        ...
                                                        title="Hapus Pendidikan Terakhir"><i
                                                        ...
                                                        document.querySelectorAll('.btn-delete').forEach(button => {
                                                            button.addEventListener('click', function(e) {
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    text: "Data Pendidikan Terakhir ini akan dihapus secara permanen!",
                                                                    icon: 'warning',
