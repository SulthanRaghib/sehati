            ...
            <div class="card">
                <div class="card-header  pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.kelas') }}" class="btn btn-outline-warning" id="kembali">Kembali</a>
                        <script>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST" action="{{ route('admin.kelas.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="tingkat"
                                                    ...
                                                    name="tingkat"
                                                    placeholder="Masukkan Tingkat Kelas (Contoh: 9, 10, 11, 12)"
                                                    value="{{ old('tingkat') }}">
                                                @error('tingkat')
