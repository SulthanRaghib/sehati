                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    <div class="tab-pane fade active show" id="features-tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ url('assets/img/features-illustration-1.webp') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features-tab-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ url('assets/img/features-illustration-2.webp') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="features-tab-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ url('assets/img/features-illustration-3.webp') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="phone-mockup text-center">
                            <img src="{{ url('assets/img/phone-app-screen.webp') }}" alt="Phone Mockup"
                                class="img-fluid" />
                        </div>
                    </div>
                    <!-- End Phone Mockup -->
