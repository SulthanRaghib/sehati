<!-- plugins:css -->
<link rel="stylesheet" href="{{ url('backend/assets/vendors/feather/feather.css') }}">
...
<!-- <link rel="stylesheet" href="{{ url('backend/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}"> -->
<link rel="stylesheet" href="{{ url('backend/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css') }}">
<link rel="stylesheet" href="{{ url('backend/assets/vendors/ti-icons/css/themify-icons.css') }}">
<link rel="stylesheet" type="text/css" href="{{ url('backend/assets/js/select.dataTables.min.css') }}">
